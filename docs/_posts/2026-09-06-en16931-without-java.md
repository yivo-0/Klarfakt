...
97/97 comparable files agree rule for rule with the reference validator (46 not comparable)
```

The 46 are recorded with the reason each cannot be compared, usually that the
